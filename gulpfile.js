...
gulp.task('compile', ['clean'], function() {
    return browserify('./lib/bespoke-convenient.js')
        .bundle({
            standalone: 'bespoke.plugins.convenient'
        })
        .pipe(source('bespoke-convenient.js'))
        .pipe(buffer())
        ...
        .pipe(gulp.dest('dist'))
        .pipe(rename('bespoke-convenient.min.js'))
        .pipe(uglify())
        .pipe(header(template([
            '/*! <%= name %> v<%= version %> ',
